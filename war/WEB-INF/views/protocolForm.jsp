...
<form:form action="" method="${param.method}" modelAttribute="protocol" class="form-horizontal" id="frmprotocol">
	<input type="hidden" name="id" value="${protocol.id}" />
	<fieldset>
   		<legend><h3>Protocols<small> ${param.sublabel}</small></h3></legend>
...
$(document).ready(function () {
 	$("#frmprotocol").validate({
 		 	rules: {
 	 		 	nome: { required: true, minlength: 2 }
 		 	}
 	});
 	
 	$("#salvar").click(function () { $("#frmprotocol").submit(); });
