...
<div>
	...
	<div style="border-bottom: 1px solid #E5E5E5;">
		<h3>Clients<small> ${label_listagem}</small></h3>
	</div>
	...
	<table class="table table-hover">
		...
		<c:forEach items="${clients}" var="m">
		<tr>
			<td><img src="${m.imagem}" width="100" /></td>
			<td>
				<spring:url value="/client/${m.id}" var="edit_url" htmlEscape="true">
	...
	<form:form id="atualizaclient" action="synch" method="GET">
